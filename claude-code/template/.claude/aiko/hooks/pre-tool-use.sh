...
AIKO_HOME="${AIKO_HOME%/}"
case "$PATH_VAL" in
  "~/"*) PATH_VAL="$HOME/${PATH_VAL#~/}" ;;
esac

case "$PATH_VAL" in
  "$AIKO_HOME/persona/origin/persona.md"|"$HOME/.aiko/persona/origin/persona.md"|".aiko/persona/origin/persona.md"|"./.aiko/persona/origin/persona.md"|*/.aiko/persona/origin/persona.md)
    echo "Refused: origin/persona.md is protected. Use /aiko-override or /aiko-reset to change override persona instead." 1>&2
    exit 2
    ;;
  "$AIKO_HOME/persona/aiko-origin.md"|"$HOME/.aiko/persona/aiko-origin.md"|".aiko/persona/aiko-origin.md"|"./.aiko/persona/aiko-origin.md"|*/.aiko/persona/aiko-origin.md)
    echo "Refused: aiko-origin.md is protected. Use /aiko-override or /aiko-reset to change override persona instead." 1>&2
    exit 2
    ;;
  "$AIKO_HOME/persona/INVARIANTS.md"|"$HOME/.aiko/persona/INVARIANTS.md"|".aiko/persona/INVARIANTS.md"|"./.aiko/persona/INVARIANTS.md"|*/.aiko/persona/INVARIANTS.md)
