...
| `runtime-profile://latest/summary` | 直近に合成した Profile の要約 |
...
| ツール | 役割 |
|---|---|
| `aiko_bind_runtime` | 人格・ユーザー・能力を合成して Runtime Profile を作る |
| `aiko_get_runtime_profile` | 合成済みの Profile を取得する |
| `aiko_report_capabilities` | Capability Manifest を使える／使えないに分ける |
| `aiko_health` | 人格を読めているか、Profile を何件持っているか |
